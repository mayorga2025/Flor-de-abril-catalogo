...
(function(){
  const costumes = [
    { id:1, name:"Traje Típico Mestizaje", description:"Vestido tradicional con bordados florales coloridos, ideal para presentaciones folclóricas.", image:"assets/trajes/mestizaje.png", price:"C$ 500", sizes:["S","M","L","XL"], category:"Mujer , Hombre", region:"Pacífico", colors:[{name:"Rojo y Blanco",gradient: "linear-gradient(90deg, #ffffffff 0%, #DC2626"}], genders:["Hombre","Mujer"], genderImages:{Hombre:"assets/trajes/hombremestizaje.png", Mujer:"assets/trajes/mujermestizaje.png"}, sizeByGender:{Hombre:["M","L","XL"], Mujer:["S","M","L","XL"]}},
  ...
  const trajes = [
    ...
    {id:17,name:"El baile de negras",image:costumes[6].image,region:"Central",historia:"Danza interpretada por parejas masculinas durante las festividades de San Jerónimo en Masaya, Nicaragua. Esta danza es una expresión cultural que celebra la herencia africana en el país, caracterizada por movimientos rítmicos y alegres que reflejan la historia y tradiciones de la comunidad.",baile:"Baile de Negras",caracteristicas:["Trajes coloridos","Movimientos rítmicos"]
    }
  ];
    ...
    return `<h2 style="margin-bottom:12px">${c.name}</h2>
      ...
      <div style="display:flex;flex-wrap:wrap;gap:24px">
        <div style="flex:1;min-width:280px">
          <div id="mainImageWrap" class="main-image-wrap"><img id="mainImage" src="${initialImage}" alt="${c.name}" style="width:100%;border-radius:22px;transition:opacity .35s ease,transform .5s ease" /></div>
